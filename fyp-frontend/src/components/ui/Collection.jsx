...
const Collection = ({collection}) => {
  ...
  return (
    <div onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}  className="relative hover:cursor-pointer">
        ...
        <div className={`absolute bottom-0 z-0 block left-1/2 -translate-x-1/2 font-semibold h-full w-full bg-gradient-to-t from-black px-6 py-2 :md:px-8 rounded-sm`}></div>
    </div>
